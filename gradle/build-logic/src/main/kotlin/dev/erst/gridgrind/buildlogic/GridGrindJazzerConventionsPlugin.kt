    ...
    override fun apply(project: Project) {
        with(project) {
            ...
            dependencies.apply {
                ...
                add("implementation", libs.library("jakarta-activation"))
                add("implementation", libs.library("jakarta-xml-bind"))
                ...
                add("testImplementation", libs.library("jakarta-activation"))
                add("testImplementation", libs.library("jakarta-xml-bind"))
                ...
                add("testImplementation", libs.library("slf4j-api"))
                ...
                add(fuzzSourceSet.implementationConfigurationName, libs.library("jakarta-activation"))
                add(fuzzSourceSet.implementationConfigurationName, libs.library("jakarta-xml-bind"))
