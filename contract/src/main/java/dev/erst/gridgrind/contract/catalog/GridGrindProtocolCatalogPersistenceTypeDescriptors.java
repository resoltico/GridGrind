      ...
      List.of(
          ...
          CatalogTypeEntryFactory.descriptorWithNotes(
              ...
              "Overwrite the opened source workbook at source.path."
                  ...
                  + " persistence.security is required and declares both final OOXML encryption"
                  + " and signature dispositions."
          ...
          CatalogTypeEntryFactory.descriptorWithNotes(
              ...
              "Save the workbook to one .xlsx path with an explicit ifExists collision policy."
                  ...
                  + " Existing-source writes require persistence.security to declare both final"
                  + " OOXML encryption and signature dispositions; NEW writes default to NONE"
                  + " on both axes when security is omitted."
