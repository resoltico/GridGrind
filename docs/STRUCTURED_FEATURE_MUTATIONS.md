...
updated: "2026-04-22"
route:
  keywords: [gridgrind, style, data validation, conditional formatting, autofilter, table, pivot table, append row, auto size, execution calculation, named range]
  questions: ["how do I apply styles in gridgrind", "how do I create data validation in gridgrind", "how do I create a table or pivot table in gridgrind", "how does execution calculation work in gridgrind", "how do I manage named ranges in gridgrind"]
---

# Structured Feature Mutation Reference

**Purpose**: Mutation reference for styles, validations, conditional formatting, autofilters,
tables, pivot tables, append-only large-file writes, calculation policy, and named ranges.
