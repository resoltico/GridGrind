...
public sealed interface ConditionalFormattingRuleReport
  ...
  /** Converts one engine conditional-formatting rule snapshot into the protocol report shape. */
  static ConditionalFormattingRuleReport fromExcel(ExcelConditionalFormattingRuleSnapshot rule) {
    return switch (rule) {
      case ExcelConditionalFormattingRuleSnapshot.FormulaRule formulaRule ->
          new FormulaRule(
              ...
              formulaRule.formula(),
              DifferentialStyleReport.fromExcel(formulaRule.style()));
      case ExcelConditionalFormattingRuleSnapshot.CellValueRule cellValueRule ->
          new CellValueRule(
              ...
              DifferentialStyleReport.fromExcel(cellValueRule.style()));
      case ExcelConditionalFormattingRuleSnapshot.ColorScaleRule colorScaleRule ->
          new ColorScaleRule(
              ...
              colorScaleRule.thresholds().stream()
                  .map(ConditionalFormattingThresholdReport::fromExcel)
                  .toList(),
      ...
      case ExcelConditionalFormattingRuleSnapshot.DataBarRule dataBarRule ->
          new DataBarRule(
              ...
              ConditionalFormattingThresholdReport.fromExcel(dataBarRule.minThreshold()),
              ConditionalFormattingThresholdReport.fromExcel(dataBarRule.maxThreshold()));
