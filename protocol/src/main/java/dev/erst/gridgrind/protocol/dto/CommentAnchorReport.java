...
/** Factual comment-anchor bounds loaded from one worksheet drawing. */
public record CommentAnchorReport(int firstColumn, int firstRow, int lastColumn, int lastRow) {
  public CommentAnchorReport {
