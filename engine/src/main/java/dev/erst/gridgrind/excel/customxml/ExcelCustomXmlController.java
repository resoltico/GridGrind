...
public final class ExcelCustomXmlController {
  ...
  public ExcelCustomXmlController(
      ExcelCustomXmlExporter exporter, ExcelCustomXmlImporter importer) {
  ...
  public List<ExcelCustomXmlMappingSnapshot> mappings(XSSFWorkbook workbook) {
  ...
  public ExcelCustomXmlExportSnapshot exportMapping(
  ...
  public void importMapping(XSSFWorkbook workbook, ExcelCustomXmlImportDefinition definition) {
    Objects.requireNonNull(workbook, "workbook must not be null");
  ...
  public static XSSFMap requireMapping(
      XSSFWorkbook workbook, ExcelCustomXmlMappingLocator locator) {
    Objects.requireNonNull(workbook, "workbook must not be null");
  ...
  public static ExcelCustomXmlMappingSnapshot snapshot(XSSFMap mapping) {
    CTMap ctMap = mapping.getCtMap();
  ...
  public static Optional<ExcelCustomXmlDataBindingSnapshot> dataBinding(CTMap ctMap) {
  ...
  public static List<ExcelCustomXmlLinkedCellSnapshot> linkedCells(XSSFMap mapping) {
  ...
  public static List<ExcelCustomXmlLinkedTableSnapshot> linkedTables(XSSFMap mapping) {
  ...
  public static Optional<String> schemaXml(XSSFMap mapping) {
  ...
  public static Optional<String> schemaXml(XSSFMap mapping, Transformer transformer) {
    Node schema = mapping.getSchema();
    if (schema == null) {
      return Optional.empty();
    }
  ...
  public static String mappingName(XSSFMap mapping) {
