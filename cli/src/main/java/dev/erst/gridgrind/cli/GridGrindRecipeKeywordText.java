...
/** Normalizes English recipe-discovery text into deterministic searchable token sets. */
final class GridGrindRecipeKeywordText {
  ...
  private GridGrindRecipeKeywordText() {}
